# ScratchCliTool Mod | v1.1.0
# Made by Letter C (cWorksLLC) and Webbrowser11 (T_cat9000_2), modded by Alejandrix2456github (AlejandrixKing245)
import scratchattach as sa # Scratchattach; Help: https://github.com/TimMcCool/scratchattach
import maskpass #password checker
import webbrowser #site opener
import time #timer
...
print("| |_____ |       ||   |_||_ |       |  |   |  |       ||       |    |   |  |  | |  ||  | |  ||   |      |       ||  | |  || | |  |")
print("|_____  ||      _||    __  ||       |  |   |  |      _||       |    |   |  |  |_|  ||  |_|  ||   |___   |       ||  |_|  || |_|  |")
